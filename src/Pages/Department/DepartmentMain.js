...
function DepartmentMain(props) {
  return (
    <div className="Department">
      ...
      <div className='DepartmentSub_1_right logins'>
        <div>
      ...
      <div className='DepartmentSub_2'>
        <DailyDeals/>
      </div>
      <div className='DepartmentSub_3'>
        <Topbrands/>
      </div>
      <div className='DepartmentSub_3_3_1'>
        <div className="MostLovedCarouselTop">
          MostLovedCarousel Top and more
        </div>
        <MostLovedCarousel/>
      </div>
      <div className='DepartmentSub_3_3_2'>
        <div className="NewArrivalsCarouselTop">
        NewArrivalsCarousel Top and more
        </div>
        <NewArrivalsCarousel/>
      </div>
      <div className='DepartmentSub_5'>
        <CitiesSlider slides={props.slides} />
      </div>
      <div className='DepartmentSub_6'>
        <div className="StoreFiltureTop">
        StoreFilture Top and more
        </div>
        <StoreFilture/>
      </div>
      <div className='DepartmentSub_6_6'>
        <div className="TopCategoriesTop">
        Top Sub-Categories
        </div>
        <TopCategories/>
      </div>
      <div className='DepartmentSub_7'>
        <Newsletter/>
      </div>
      <div className='DepartmentSub_8'>
          <ShippingDetails/>
      </div>
    </div>
  )
